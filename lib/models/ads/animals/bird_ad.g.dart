...
class _$BirdAd extends BirdAd {
  ...
  _$BirdAd._(
    ...
    if (creator == null) {
      throw new BuiltValueNullFieldError('BirdAd', 'creator');
    }
    if (name == null) {
...
class BirdAdBuilder implements Builder<BirdAd, BirdAdBuilder>, AnimalAdBuilder {
  _$BirdAd _$v;
  ...
  @override
  void replace(covariant BirdAd other) {
    if (other == null) {
